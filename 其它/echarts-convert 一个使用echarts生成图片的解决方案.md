## 原插件git地址
第一个是原作者
[https://gitee.com/saintlee/echartsconvert](https://gitee.com/saintlee/echartsconvert)
第二个是好心人发布在github上的地址
[https://github.com/liufeiyun/EchartConvert](https://github.com/liufeiyun/EchartConvert)
...
- 这里要进入echarts-convert.js目录


## echart-convert.js 
稍微改过东西但不记得改过啥，我也看不懂下面的代码，当时就根据报错改的
```
/**
